...
- It uses the up-to-date `google-closure-compiler` package on npm, rather than `google-closure-compiler-js`
- It doesn't require you to have JavaScript installed
